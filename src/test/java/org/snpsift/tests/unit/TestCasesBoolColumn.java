...
public class TestCasesBoolColumn {

    @Test
    public void testGet01() {
        BoolColumn column = new BoolColumn("test", 6);
    ...
    public void testSize() {
        BoolColumn column = new BoolColumn("test", 5);
    ...
    public void testRand() {
        for(int iter = 0 ; iter < 100; iter++) {
            ...
            BoolColumn column = new BoolColumn("test", size);
