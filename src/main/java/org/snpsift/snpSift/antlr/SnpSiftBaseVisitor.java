...
/**
 * This class provides an empty implementation of {@link SnpSiftVisitor},
 ...
 */
public class SnpSiftBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements SnpSiftVisitor<T> {
	/**
	 * {@inheritDoc}
	 *
